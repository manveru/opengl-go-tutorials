...
var (
  ...
  lPressed = false // L button pressed?
  fPressed = false // F button pressed?
  ...
  lightAmbient1  = [4]gl.GLfloat{0.0, 1.0, 0.0, 1.0} // Ambient light values
  lightDiffuse1  = [4]gl.GLfloat{0.0, 1.0, 0.0, 1.0} // Diffuse light values
  lightPosition1 = [4]gl.GLfloat{2.0, 0.0, 2.0, 1.0} // Light position

  lightAmbient2  = [4]gl.GLfloat{1.0, 0.0, 0.0, 1.0} // Ambient light values
  lightDiffuse2  = [4]gl.GLfloat{1.0, 0.0, 0.0, 1.0} // Diffuse light values
  lightPosition2 = [4]gl.GLfloat{-2.0, 0.0, 2.0, 1.0} // Light position
...
func initGL() {
  ...
  // Setup the light
  gl.Lightfv(gl.LIGHT1, gl.AMBIENT,  (*gl.GLfloat)(unsafe.Pointer(&lightAmbient1 ))) // ambient lighting
  gl.Lightfv(gl.LIGHT1, gl.DIFFUSE,  (*gl.GLfloat)(unsafe.Pointer(&lightDiffuse1 ))) // make it diffuse
  gl.Lightfv(gl.LIGHT1, gl.POSITION, (*gl.GLfloat)(unsafe.Pointer(&lightPosition1))) // and place it
  gl.Enable(gl.LIGHT1) // and finally turn it on.

  gl.Lightfv(gl.LIGHT2, gl.AMBIENT,  (*gl.GLfloat)(unsafe.Pointer(&lightAmbient2 ))) // ambient lighting
  gl.Lightfv(gl.LIGHT2, gl.DIFFUSE,  (*gl.GLfloat)(unsafe.Pointer(&lightDiffuse2 ))) // make it diffuse
  gl.Lightfv(gl.LIGHT2, gl.POSITION, (*gl.GLfloat)(unsafe.Pointer(&lightPosition2))) // and place it
